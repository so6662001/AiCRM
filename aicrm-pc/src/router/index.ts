...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'blacklist', name: 'Blacklist', component: () => import('@/views/customer/CustomerBlacklist.vue'), meta: { title: '客户黑名单', icon: 'Warning' } },
      { path: 'enterprise', name: 'EnterpriseSearch', component: () => import('@/views/enterprise/EnterpriseSearch.vue'), meta: { title: '企业查询', icon: 'Search' } },
      { path: 'reports', name: 'SalesReport', component: () => import('@/views/report/SalesReport.vue'), meta: { title: '数据报表', icon: 'DataAnalysis' } },
